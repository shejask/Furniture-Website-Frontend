...
const BlogDetailTwo = () => {
    ...
    const currentBlogIndex = allBlogs.findIndex(blog => blog.id === blogId);
    const previousBlog = currentBlogIndex > 0 ? allBlogs[currentBlogIndex - 1] : null;
                    ...
                    <div className="blog-content flex justify-between max-lg:flex-col gap-y-10">
                        <div className="main xl:w-3/4 lg:w-2/3 lg:pr-[15px]">
                            ...
                            <div className="bg-img md:py-10 py-6">
                                <Image
                                    src={blogMain.thumbImg || blogMain.imageUrl || ''}
                                    width={5000}
                                    height={4000}
                                    alt={blogMain.altText || blogMain.title}
                            ...
                            <div className="content">
                                ...
                                {blogMain.content && (
                                    <>
                                        ...
                                        <div className="body1 mt-2">{blogMain.content}</div>
                                    </>
                                )}
                                ...
                                <div className="quote-block md:mt-8 mt-5 py-6 md:px-10 px-6 border border-line md:rounded-[20px] rounded-2xl flex items-center md:gap-10 gap-6">
                                    ...
                                    <div>
                                        <div className="heading6">&ldquo;For bras, I love our Cotton Jersey Scoop Bralette – it&apos;s lined with this amazing power mesh so you get great support and is so comfy I can sleep in it.&rdquo;</div>
                                ...
                                {previousBlog ? (
                                    <>
                                        <div className="left cursor-pointer"
                                            onClick={() => handleBlogDetail(previousBlog.id)}
                                        >
                                            <div className="text-button-uppercase text-secondary2">Previous</div>
                                            <div className="text-title mt-2">{previousBlog.title}</div>
                                        </div>
                                    </>
                                ) : (
                                    <>
                                        <div className="left cursor-pointer"
                                            onClick={() => handleBlogDetail(allBlogs[allBlogs.length - 1].id)}
                                        >
                                            <div className="text-button-uppercase text-secondary2">Previous</div>
                                            <div className="text-title mt-2">{allBlogs[allBlogs.length - 1].title}</div>
                                        </div>
                                    </>
                                )}
                                {nextBlog ? (
                                    ...
                                    <>
                                        <div className="right text-right cursor-pointer"
                                            onClick={() => handleBlogDetail(allBlogs[0].id)}
                                        >
                                            <div className="text-button-uppercase text-secondary2">Next</div>
                                            <div className="text-title mt-2">{allBlogs[0].title}</div>
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="list-comment md:mt-[60px] mt-8">
                                ...
                                <div className="list-review mt-6">
                                    <div className="item">
                                        ...
                                        <div className="mt-3">I can&apos;t get enough of the fashion pieces from this brand. They have a great selection for every occasion and the prices are reasonable. The shipping is fast and the items always arrive in perfect condition.</div>
