                    ...
                    <div className="header-main flex items-center justify-between h-full">
                        ...
                        <div className="form-search relative max-lg:hidden z-[1]">
                            ...
                            {(searchKeyword.trim().length > 0) && (
                                <div className="absolute top-full mt-2 w-[360px] max-w-[90vw] bg-white border border-line rounded-lg shadow-md p-3">
                                    {searching ? (
                                                    ...
                                                    {searchResults.map(p => (
                                                        <li key={p.id}>
                                                            <Link href={`/product/default?id=${p.id}`} className="flex items-center gap-3 hover:bg-surface px-2 py-2 rounded">
                                                                <img src={(p.thumbImage?.[0] || p.images?.[0] || '/images/other/404-img.png')} alt={p.name} className="w-10 h-10 rounded object-cover" />
                                                                <div className="flex-1">
